...
/* USER CODE BEGIN PFP */
static void Trig_Go_standby(void);
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      HW_TS_Start(BleApplicationContext.Standby_timer_Id, (uint32_t)(100*1000/CFG_TS_TICK_VAL));
...
static void Trig_Go_standby(void)
{
  UTIL_SEQ_SetTask(1<<CFG_TASK_GO_STANDBY_ID, CFG_SCH_PRIO_0);
}
